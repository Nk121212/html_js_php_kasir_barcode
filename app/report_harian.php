    <?php $active = 'report_harian'; include 'template/header.php'; ?>
  ...
  $(document).ready(function(){
    ...
    var table_report = $('#table-report').DataTable( {
      ajax: {
        url: "api/datatable/report_harian.php",
        data: function(data){
    ...
    $('#btn_download_excel').click(function(){
      var url = 'export_excel/export_file.php?target=report_harian';
      window.open(url, '_blank');
    })

    $('#btn_download_pdf').click(function(){
      var url = 'export_pdf/export_file.php?target=report_harian';
      window.open(url, '_blank');
    })
