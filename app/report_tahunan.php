    <?php $active = 'report_tahunan'; include 'template/header.php'; ?>
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      var table_report = $('#table-report').DataTable( {
        ajax: {
            url: "api/datatable/report_tahunan.php",
            data: function(data){
      ...
      $('#btn_download_excel').click(function(){
        var url = 'export_excel/export_file.php?target=report_tahunan';
        window.open(url, '_blank');
      })

      $('#btn_download_pdf').click(function(){
        var url = 'export_pdf/export_file.php?target=report_tahunan';
        window.open(url, '_blank');
      })
